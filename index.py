...
def search():
    ...
    output = template('template/index',button="search",date=request.GET.get('task1'),IP=request.GET.get('task2'),username=request.GET.get('task3'))
...
run(server=PasteServer(host='192.168.1.128'))
